...
def main() -> None:
    ...
    print("phase7_8_template_ready=", report.get("phase7_8_template_ready"))
    print("future_executor_approval_template_created=", report.get("future_executor_approval_template_created"))
    print("template_guard_passed=", report.get("template_guard_passed"))
