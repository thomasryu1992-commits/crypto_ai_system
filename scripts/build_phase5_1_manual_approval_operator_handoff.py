...
def main() -> None:
    ...
    print("manual_approval_submission_template_created=", report.get("manual_approval_submission_template_created"))
    print("manual_approval_submission_created=", report.get("manual_approval_submission_created"))
    print("approval_intake_submitted=", report.get("approval_intake_submitted"))
