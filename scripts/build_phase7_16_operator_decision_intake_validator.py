...
def main() -> None:
    report = persist_phase7_16_operator_decision_intake_validator_report()
    print(report.get("status"))
    print("phase7_16_intake_validation_ready=", report.get("phase7_16_intake_validation_ready"))
    print("operator_decision_intake_validation_passed=", report.get("operator_decision_intake_validation_passed"))
    print("validated_fixture_only=", report.get("validated_fixture_only"))
