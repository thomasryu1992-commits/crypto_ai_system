...
def main() -> None:
    ...
    print("phase7_11_enablement_design_ready=", report.get("phase7_11_enablement_design_ready"))
    print("future_executor_enablement_design_packet_created=", report.get("future_executor_enablement_design_packet_created"))
    print("enablement_design_guard_passed=", report.get("enablement_design_guard_passed"))
