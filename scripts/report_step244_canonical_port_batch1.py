...
def build_step244_batch1_report(root: Path) -> dict:
    ...
    ported_remaining = sorted(set(BATCH1_PORTED_LEGACY_MODULES) & remaining_legacy_modules)

    return {
        "report_type": "step244_canonical_port_batch1_report",
        "status": "BATCH1_CANONICAL_PORT_APPLIED",
        "batch_scope": "SMALL_HIGH_PRIORITY_EXACT_PORTS",
        "ported_modules": BATCH1_PORTED_LEGACY_MODULES,
        ...
        "next_step": {
            "name": "Step245 v5 Canonical Port Patch Batch 2",
            "goal": "Port the next small validated canonical port batch, preferably another isolated HIGH-priority group.",
        },
    }


def main() -> int:
    parser = argparse.ArgumentParser(description="Build Step244 canonical port batch 1 report.")
    parser.add_argument("--root", default=".", help="Repository root")
    parser.add_argument("--output", default="data/reports/step244_canonical_port_batch1_report.json")
    ...
    report = build_step244_batch1_report(root)
