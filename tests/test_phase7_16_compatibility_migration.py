...
def test_phase7_16_compatibility_migration_checker() -> None:
    result = subprocess.run(
        [sys.executable, "scripts/check_phase7_16_compatibility_migration.py"],
        cwd=ROOT,
    ...
    assert "PHASE7_16_COMPATIBILITY_MIGRATION_VALID" in result.stdout


def test_phase7_16_legacy_and_semantic_paths_share_exported_objects() -> None:
...
def test_phase7_17_uses_semantic_phase7_16_contract() -> None:
    text = (
        ROOT
        / "src"
        / "crypto_ai_system"
