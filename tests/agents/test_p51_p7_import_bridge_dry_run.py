...
def test_p51_valid_candidate_dry_run_would_accept_p7_but_does_not_persist_status():
    report = build_p51_p7_import_bridge_dry_run_report(candidate=_valid_candidate_fixture())
...
def test_p51_candidate_missing_status_polling_is_rejected_or_blocked():
    ...
    report = build_p51_p7_import_bridge_dry_run_report(candidate=candidate)
