...
def _hash_payload_without(payload: Mapping[str, Any], hash_field: str) -> str:
    body = dict(payload)
...
def _verify_embedded_hash(payload: Mapping[str, Any], field: str) -> bool:
    ...
    return isinstance(expected, str) and bool(expected) and _hash_payload_without(payload, field) == expected
