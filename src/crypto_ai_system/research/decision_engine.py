...
def run_research_decision() -> dict:
    ...
    decision = {
        ...
        "final_score": score,
        "allow_long": bool(trade_permission.get("allow_long", False)) and not signal_qa_blocks_decision and not legacy_blocker_blocks_decision,
        "allow_short": bool(trade_permission.get("allow_short", False)) and not signal_qa_blocks_decision and not legacy_blocker_blocks_decision,
        "allow_new_position": bool(trade_permission.get("allow_new_position", False)) and not signal_qa_blocks_decision and not legacy_blocker_blocks_decision,
        "risk_level": "blocked" if (signal_qa_blocks_decision or legacy_blocker_blocks_decision) else str(trade_permission.get("risk_level", "blocked")),
