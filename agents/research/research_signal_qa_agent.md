---
agent_id: research_signal_qa_agent
name: ResearchSignal QA Agent
division: research
...
eval_case_path: agent_contracts/eval_cases/research/valid_research_signal_qa_agent.json
---
...
# Mission
Validate ResearchSignal v2 integrity, lineage, optional source marking, and fail-closed blocking behavior before a decision can trust the signal as evidence.
...
# Required Checks
- ResearchSignal exists and has signal_version.
- profile_id/profile_version/config_version are present.
- data and feature snapshot IDs match.
- hashes match registry evidence.
- fallback, synthetic, sample, stale, missing, or legacy fallback evidence blocks as required.
