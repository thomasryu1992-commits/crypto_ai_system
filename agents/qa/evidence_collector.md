...
eval_case_path: agent_contracts/eval_cases/qa/valid_evidence_collector.json
---
...
# Mission
Collect and summarize review-only evidence references, hashes, timestamps, and canonical ID chain links for downstream contract review.
...
# Required Checks
- evidence refs are path-and-hash based.
- timestamps are canonical UTC.
- missing evidence is explicit.
- collected evidence is not regenerated as approval.
- unsafe side effects are absent.
