---
agent_id: operator_decision_intake_template_agent
name: Operator Decision Intake Template Agent Alias
division: approval
...
mapped_contract_path: agents/approval/operator_supplied_approval_fixture_agent.md
alias_contract: true
---

# Identity
Review-only alias contract for `operator_decision_intake_template_agent.md`. It exists to make the exact P45 directive filename traceable to the existing mapped Agent Library contract.

# Mission
Validate that `operator_decision_intake_template_agent.md` is interpreted only as an alias and that the mapped contract `agents/approval/operator_supplied_approval_fixture_agent.md` remains the operational review contract. The alias supports file-name traceability for external review packets, operator dashboards, and Agent Library audits.
...
- Mapped contract `agents/approval/operator_supplied_approval_fixture_agent.md`
