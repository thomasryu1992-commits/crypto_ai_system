...
Only the external credential-bearing process may set `X-Api-Key`. The initial account snapshot must include the balance, positions, and orders keys. P71 validates:
